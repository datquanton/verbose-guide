...
| **✅ THE US WEEK IS NOW FULLY MAPPED, ALL FROM PRIMARIES (completed 09-Aug 21:54): CPI WED 12-AUG · PPI THU 13-AUG · ADVANCE RETAIL SALES FRI 14-AUG — all 08:30 ET.** | Both are **absent from this file** — *"retail sales"* returns zero contexts and every apparent *"PPI"* hit is a spurious substring match inside my own timestamp-mapping text. ⚠ **The only source found has systematically wrong weekday labels** — it says *"Tuesday, August 12"* (12-Aug is a **Wednesday**), *"Thursday, August 14"* (a **Friday**), and *"Friday … retail sales"* implying 15-Aug (a **Saturday**, when US data is never released). **Verified with `date -d`, not by hand.** **Sources: BLS for CPI and PPI, CENSUS for retail sales (a different issuer, which is why the BLS schedule could not settle it).** ⚠ **THE SECONDARY SOURCE'S ERROR PATTERN, now measurable on three items and characterised correctly at the third attempt: CPI — weekday WRONG (said Tuesday; is Wednesday), date RIGHT (12-Aug). PPI — weekday RIGHT (Thursday), date WRONG (said 14; is 13). RETAIL SALES — weekday RIGHT (Friday), date not stated and would have been wrong if inferred from its own sequence (15-Aug, a Saturday).** ***Exactly one element was correct in each case and which one varied — so neither "constant offset" nor any correction rule was available, and discarding was the only safe response.*** ⚠ **CORRECTED 20:54 — BLS puts July PPI on THU 13-AUG, and that FALSIFIES my "systematically one day behind" characterisation:** for CPI the source's *label* lagged (said Tuesday, is Wednesday); for PPI its *date* led (said 14, is 13) while the weekday **Thursday was right**. ***The pairs are unreliable in BOTH directions, so neither element can be trusted alone — but the refusal to use its dates was correct, and the date it gave for PPI was indeed wrong.*** **RETAIL SALES remains unestablished — it is a Census release, not BLS, and no Census date was returned.** | **retail sales only:** a Census schedule or a second source |
...
- **✅ 21:54 ICT SUN 09-AUG · MACRO (lane 1) — THE US WEEK IS FULLY MAPPED FROM PRIMARIES, and the secondary's
  ...
  **CENSUS CONFIRMS: July 2026 Advance Monthly Retail Sales releases FRI 14-AUG-2026, 08:30 EDT.** That
  completes the week: **CPI Wed 12-Aug (BLS) · PPI Thu 13-Aug (BLS) · Advance retail sales Fri 14-Aug
  (Census)**, all 08:30 ET. ***Two hours ago the gate table's US coverage stopped at 07-Aug; it now runs
  through the week, and every date came from the issuing agency.***
  **THE ERROR PATTERN, measured on three items rather than asserted from one or two.** **CPI** — weekday
  **wrong** (said Tuesday; 12-Aug is a Wednesday), date **right**. **PPI** — weekday **right** (Thursday),
  date **wrong** (said 14; BLS says 13). **Retail sales** — weekday **right** (Friday), date not stated and
  **would have been wrong if inferred** from the source's own sequence, which implied 15-Aug, a **Saturday**.
  ***So exactly one element was correct in each case, and which one varied.***
  ⚠ **THAT IS WHY NEITHER EARLIER CHARACTERISATION WORKED.** At 19:54: *"consistently one day behind"* —
  **false.** At 20:54: *"unreliable in both directions"* — **true but vague.** **The precise statement: one of
  the two elements is right each time and you cannot tell which, so no correction rule exists and discarding
  was the only safe response.** ***Three attempts at one source's defect, each better than the last, and only
  the third survives contact with all three datapoints. The lesson is sample size in diagnosis — and the FIRST
  diagnosis was the dangerous one, because it was the only one that would have licensed acting on the bad
  dates.***
  **THE WEEK AHEAD, ASSEMBLED:** **Mon 10-Aug** — MBB's last cum session · **Tue 11-Aug** — MBB ex-rights ·
  **Wed 12-Aug** — MBB record date **and** US CPI · **Thu 13-Aug** — US PPI **and** weekly jobless claims ·
  **Fri 14-Aug** — US advance retail sales **and KDH's H1 standalone/parent AUDITOR-REVIEWED statements** (45
  days, Circular 96/2020), which this file calls *"the document that settles KDH's ₫321bn vs ₫1,097bn basis
  question"* **on 20.3% of the book.** Consolidated set follows **29-Aug**. ***Four of the five sessions carry
  a dated item and two carry two.***
  **Nothing modelled. No confidence moved. No trigger fires** — trigger 5 stays inapplicable to macro prints
  on its *"in that name"* wording, and KDH's 14-Aug filing is a gate already on file rather than a new
  catalyst. ⚠⚠ **MBB'S LAST CUM SESSION IS TOMORROW, MONDAY 10-AUG.**

- **⚠ 20:54 ICT SUN 09-AUG · MACRO (lane 1) — PPI corroborated from the primary: THU 13-AUG-2026, 08:30 ET.
  And it FALSIFIES my own characterisation from one hour ago.**
  **THE FACT: BLS puts July 2026 PPI on 13-Aug-2026, 08:30 ET.** 13-Aug is a **Thursday** (`date -d`
  verified). **So the week now has two inflation prints in 48 hours — CPI Wed 12-Aug, PPI Thu 13-Aug — into a
  Fed that held 3.50–3.75% on a 9–3 vote with three HIKE dissents.**
  ⚠ **THE CORRECTION I OWE.** At 19:54 I wrote that the calendar source's *"weekday labels are consistently
  one day behind its dates."* **Falsified.** For **CPI** it said *"Tuesday, August 12"* — **the label lagged**
  (12-Aug is a Wednesday). For **PPI** it said *"Thursday, August 14"* — and BLS says **13-Aug, which IS a
  Thursday**, so **the weekday was right and the date led by one.** ***The errors run in opposite directions.
  The source is not systematically offset; its date–weekday pairs are simply unreliable, in both directions.***
  **WHAT SURVIVES, and it is the part that mattered: the refusal to take its dates was correct, and the PPI
  date it gave was indeed wrong by a day.** ***The decision was right and the reason I gave for it was too
  strong*** — the useful rule is *"this source's date–weekday pairs cannot be trusted,"* **not** *"this source
  has a known constant offset"*, **because a constant offset would have licensed CORRECTING the dates rather
  than discarding them — and that would have produced 12-Aug for PPI. Wrong by a day.**
  **RETAIL SALES REMAINS UNESTABLISHED and is not guessed.** It is a **Census Bureau** release, not BLS —
  which is why the BLS schedule does not settle it. **The gate row now carries PPI as dated and retail sales
  as outstanding, with the re-open trigger narrowed to retail sales alone.**
  **Second time in two hours that going to the primary settled something a secondary muddled** — `bls.gov` for
  CPI yesterday and for PPI now. **Both times the secondary had the right month and the wrong pairing, and
  both times the primary was one search away and was not tried first.**
  **Nothing modelled. No confidence moved. No trigger fires.** ⚠⚠ **MBB'S LAST CUM SESSION IS TOMORROW,
  MONDAY 10-AUG.**
...
- **⚠⚠ 18:54 ICT SUN 09-AUG · MACRO (lane 1) — US JULY CPI LANDS WED 12-AUG, TWO SESSIONS AWAY, AND IT WAS
  ...
  24-Aug. A gate row has been added.** *(Clock read first; 17:53 was reported as nothing material and stands.)*
  **THE BASELINE, also not previously on file — June 2026: headline −0.4% MoM SA, +3.5% YoY NSA; core
  unchanged MoM SA, +2.6% YoY NSA.** *The bases are stated because this file has been caught nine times on
  unstated ones.*
  **WHY IT MATTERS ON THIS FILE'S OWN CHAIN, not on a general view.** The file holds **FOMC held at
  3.50–3.75% on 29-Jul with a 9–3 vote and three HIKE dissents**, and concluded that this *"keeps the dollar
  firm, keeps VND under pressure"* and *"boxes SBV in on a second side."* ***US CPI is the print that resolves
  that chain, and it was untracked two sessions out.***
  ⚠⚠ **A TENSION THE FILE DOES NOT HAVE, and it is the part worth keeping.** The file's inflation leg rests on
  **survey prices-paid**: ISM Services **70.3** (vs 65.0 est, from 67.7) and ISM Manufacturing **71.1** (vs
  71.0 est, **down 1.9pp from June's 73.0**) — both above 70. **And the June CPI actually printed SOFT:
  headline negative on the month, core flat.** ***Survey prices-paid and realised CPI are different measures
  and they currently disagree.*** **The file's phrase "the inflation leg is corroborated out of sample" means
  corroborated across two SURVEYS, not against the price index itself — a distinction never drawn.**
  **TRIGGER 5 CONSIDERED AND REJECTED ON THE WORDING**, stated because I nearly flagged it as a candidate. The
  framework reads *"a dated catalyst lands within 5 sessions of a proposed trade **in that name**."* **A US
  macro print is not "in that name," so trigger 5 does NOT fire.** *The qualifier is doing real work and
  reading it settled the question.*
  **SAME SPECIES AS THE 05-AUG LESSON, INVERTED.** That entry found *"a gate placed in the future for an event
  ALREADY PAST suppressed the search for two days."* **Here there is no gate at all for an event two sessions
  out — the gate table's US coverage simply stops at 07-Aug.**
  *Calendar note, explicitly not a causal claim: **12-Aug is also MBB's record date**, so the CPI print lands
  in the same 48 hours as the book's largest pending corporate action.* **Nothing modelled. No confidence
  moved. No trigger fires.** ⚠⚠ **MBB'S LAST CUM SESSION IS TOMORROW, MONDAY 10-AUG.**
...
- **01:53 ICT · BANKS (structure sweep, pass 9 — the last named item) — the first profit figure anywhere in the
  ...
  **WHAT IS NOW ON FILE.** **MB Life** (renamed from MB Ageas Life in **August 2025** — *same company, recorded
  so a future sweep does not treat them as two*), a JV of MB, **Ageas Group** (Belgium) and **Muang Thai Life**
  (Thailand), established 2016. **H1/2026: total revenue ~₫3,000bn — premium ~₫2,400bn, investment ~₫550bn —
  and PBT ₫270bn, up 2.3× YoY.** **MIC** (Military Insurance Corporation): **H1 revenue ~₫3,750bn, +32%.** **The
  non-life arm is 25% larger than the life arm by revenue** — the reverse of the usual bancassurance shape, and
  a reflection of MBB's military and corporate franchise. Combined insurance revenue **~₫6,750bn**.
  **AND HERE IS THE CORRECTION TO MY OWN 16:53 ENTRY.** That entry **refused to compute any ratio**, correctly,
  because every figure was **revenue** against bank **PBT**. **The refusal was right. The rhetoric was not.** It
  called insurance *"a whole earnings pillar"* and said the finding *"runs against this file's prevailing bank
  view"* — language implying materiality the first profit datum does not support. **MB Life's ₫270bn of PBT is
  1.34% of MBB's H1 PBT of ₫20,188bn — and that is before the JV split, so MBB's share is smaller still. That
  is not a pillar. It is a rounding item.**
  **THE MECHANISM IS GENERAL AND WORTH KEEPING.** **MB Life's PBT margin is 9.0%** (270 on 3,000); a broker in
  this book runs 56–59%. **So an insurer's revenue overstates its profit contribution by roughly six times
  relative to other financial lines** — premiums arrive before claims, and reserves are struck against them.
  **That is exactly why the 16:53 refusal to divide revenue into PBT was right, and exactly why calling the
  revenue a pillar was wrong. The discipline and the prose disagreed, and the prose is what travels.**
  **WHAT SURVIVES FROM 16:53, STATED FAIRLY RATHER THAN WITHDRAWN WHOLESALE.** *(1)* **The zero was real** —
  "insurance", "bancassurance", "Manulife" and "bảo hiểm" appeared **zero** times in a file 51.5% invested in
  Vietnamese banks, and that remains a genuine structural gap. *(2)* **All three banks own their insurers**, and
  TCB's 19:53 structure — TCLife 80% with **20% held by Vingroup companies**, TCGIns 11%→68% — is substantive
  **independent of size**. *(3)* **The growth is real**: MB Life PBT +2.3×, MIC revenue +32%, VPB cross-sell
  +40% — **small base, fast growth, both true.** **What does not survive is the claim that this materially
  offsets item 26's provisioning-flattered PBT finding. On the only profit figure available it does not come
  close.**
  **STILL NOT ESTABLISHED, AND DELIBERATELY NOT GUESSED:** MBB's percentage of **MB Life** (Ageas and Muang Thai
  are partners) and of **MIC**. MIC is separately listed and a percentage is easy to find — **and today has twice
  shown what an undated ownership percentage costs** (VPB's expired 99.95%; the TCX count that expired at a
  dividend), **so no figure is asserted without its date.** **MIC's profit is also not given — only revenue — so
  the larger of MBB's two insurers remains unsized on the measure that matters.**
  **NOTHING MODELLED.** Confidence was not raised at 16:53 and is not lowered now: **the forecast never contained
  this either way, which is itself the open question in item 33.**

- **00:53 ICT · BROKERS (structure sweep, pass 8 — closing the last named gap) — the four-broker comparable
  set is complete, and the market has sorted it into two clean tiers.**
  *(Vietnam closed; US mid-session.)*
  **THE LAST GAP CLOSED.** **VCI at 30-Jun-2026: equity ₫17,137bn, total assets ₫39,727bn, margin book
  ₫16,644bn, margin/equity 0.97×.** That completes a set assembled across six sweeps today, all on ~30-Jun
  equity against ~20–24 July market caps.
  **THE SET.** **P/B — TCX 2.49×, VCK (VPS) 2.32–2.50×, VCI 1.378×, VPX 1.36–1.47×.** **ROE on TTM earnings —
  VCK 14.3–15.5%, TCX 12.4%, VPX 10.5%, VCI 7.8%.** **The market has sorted these four into two clean tiers —
  about 2.4× and about 1.4×, a 74% premium for the top tier — and the P/B order matches the ROE order with
  exactly one inversion.**
  **AND THE INVERSION IS THE 11:53 FINDING, NOW TESTED AGAINST FOUR NAMES INSTEAD OF ONE.** **TCX ties VCK on
  P/B while earning 2–3 points less ROE.** **What this adds is a reframing, not a reversal: TCX is not an
  outlier in the sector — it is at the top of a two-tier market, and its tier-mate earns more.** The 12:53 and
  13:53 qualifications stand unchanged: **TCBS's fee franchise does not sit on the balance sheet and cannot show
  up in ROE either, and that remains untested.**
  **VCI — AND THE MARKET HAS ALREADY DONE WHAT THIS FILE HAS BEEN ARGUING.** **VCI is the least profitable of
  the four at 7.8% ROE and the most levered at 2.32× assets/equity — higher than TCX's 2.20×.** *Most levered
  and least profitable is a coherent and unflattering combination, and it is new.* **But at 1.378× P/B it sits
  roughly where that ROE puts it relative to the others. The file's negativity on VCI is not a disagreement with
  the market; the market has marked it down already.** Worth saying because **item 29** concerns a suspended
  optimizer ADD on this name, and *"cheap for a reason"* and *"cheap"* are different claims **this arithmetic
  cannot separate.**
  **A STANDING CRITICISM SOFTENED BY THE FULL SET.** The file has repeatedly singled VCI out for unused capacity
  — *"unused capacity that stays unused in the best conditions on record is a description of the business, not
  an option on it."* **Margin/equity across the four: TCX 1.13×, VPX 1.12×, VCK 1.00×, VCI 0.97×.** **VCI is
  lowest, but 0.03× below VPS — the largest broker in the market by share.** **So "VCI does not use its
  capacity" is true and is not VCI-specific: it survives as a level statement and weakens as a comparative one.**
  Stated because the file has made it comparatively more than once.
  **AND A DISCREPANCY INSIDE THIS FILE THAT THE SET EXPOSES.** `_BROKERAGE_STRUCTURAL` already carries *"VCI
  ~0.97×, VPX ~1.07×, TCBS ~1.56×."* **VCI's 0.97 is confirmed exactly. But TCBS's own 30-Jun-2026 disclosure
  puts its margin/equity at 1.13× (51,522.4 / 45,782 = 1.125), not 1.56×.** Either an older vintage or a
  different numerator; **not reconciled here. The company's own figure is preferred and the old one is flagged
  rather than overwritten**, per the file's practice on superseded numbers.
  *Balance-sheet shape, for completeness: **margin is 41.9% of VCI's assets, against TCBS 51.2% and VPS 65.4%**
  — a wide dispersion across three disclosed brokers, and another reason the cluster should not be treated as
  one business. VPX's share is not established.*
  **NOTHING MODELLED.** No weight, branch, probability, price or confidence moved on any of the four.

## 2026-08-05

- **23:53 ICT · CONCENTRATION (structure sweep, pass 7) — the named to-do from 22:53. The percentage that came
  back is 99.95% and it must not be used: it expired at an IPO. Caught before it entered an arithmetic chain.**
  **THE STALE FIGURE.** VPBank's stake in VPBankS is reported at **99.95%** — but **VPBankS IPO'd nearly
  ₫13,000bn and listed on HOSE on 11-December-2025.** **A 99.95% stake cannot survive a raise that size. The
  percentage is pre-IPO and has expired** — the same class of error as TCX's listing-date share count, which was
  *accurate for its date* and produced a 4.6% valuation failure when carried forward. **The only reason this one
  is cheap is that it was caught before use.**
  **A BOUND, DERIVED AND LABELLED AS A BOUND.** At the ₫33,900 IPO price on file, ~₫13,000bn is **~383.5m
  shares**; VPX has 1,875m outstanding, so pre-IPO was **~1,491.5m**. **99.95% of 1,491.5m is 79.5% of the
  post-IPO 1,875m.** **So VPB's stake is at most ~79.5%, and lower if any of the offering was a secondary
  sell-down — which is not established.** *TCB's 94.17% is a disclosed figure; this is a ceiling reconstructed
  from three numbers, and the two are not the same quality of input.*
  **THE VPX LOOK-THROUGH, CORRECTED — and it moves far less than TCX's.** At 79.5%, VPB's stake is worth
  **₫39,655bn = 20.0% of VPB's ₫198,348bn cap**, so indirect exposure is 10.0 × 20.0% = **2.00pp** and **VPX is
  4.80% of the book against the 4.22% on file.** **Why so much smaller than TCX's 12.23 → 23.63:** VPB owns
  **less** of VPX (~79.5% vs 94.17%), VPX is a **smaller** share of its parent (14.2% vs 19.2% of PBT), and the
  **multiple gap is narrower** (13.93/6.48 = 2.15× against TCX's 2.78×) — **three factors all pointing the same
  way.** **Total effective brokerage is therefore 31.53%, correcting the 30.95% stated at 22:53.**
  **AND THE LARGER FINDING IS A RATIO THIS FILE HAS NEVER COMPUTED.** VPBankS raised equity to **nearly
  ₫34,000bn** by end-2025 — top 2 in the industry. At VPX's ₫49,875bn cap that is a **P/B of 1.47×**, and on
  equity grown by H1's ₫2,673bn PBT, about **1.36×**. **Against the other two large brokers priced today — TCX
  2.49×, VCK 2.32–2.50× — VPX trades at roughly 60% of their multiple.** **This file has spent the day
  interrogating TCX's 2.49× as "the priciest in the book" and benchmarking it against VPS — and never computed
  the P/B of the third broker it already owns.** *No conclusion drawn about which is right: VPX's discount has
  candidate explanations already on file — FVTPL-driven earnings quality (its own armed criterion) and a
  ₫38,000bn margin book against ~₫34,000bn of equity. **Explaining a discount is not justifying it, and neither
  is done here.***
  **A PATTERN ACROSS THREE DATED VIETNAMESE IPOs, AND IT BEARS ON A LIVE KILL CRITERION.** **VPX is ₫26,600
  against its ₫33,900 issue — −21.5%. VCK is −18.8% cap-to-cap from listing. HPA is −23.6% from its IPO price.
  Three 2025-vintage issues this file has now priced, all down 19–24%.** At 15:53 today the escape route for
  **VCI's kill criterion** was identified as its **IB pipeline — US$400–500m of issuance advisory.** **An
  underwriter's ability to price and place new paper depends on the aftermarket, and the aftermarket this file
  can see is uniformly negative.** *Three observations, not a market statistic, and not a forecast of VCI's Q3 —
  a stated headwind to the one route offered as favourable.*
  *Still not established: **VCI's equity**, so its P/B cannot be computed and the broker P/B set remains three
  of four. Named as the next gap.*
  **NOTHING MODELLED.** The corrected look-through is **stated, not applied** — cluster definitions and
  optimizer config are human-only under §4.

- **22:53 ICT · CONCENTRATION (structure sweep, pass 6) — ⚠ one missing percentage doubles the file's own
  concentration escalation. Techcombank owns 94.17% of TCBS, and that number appears nowhere in this repo.**
  **THE ARITHMETIC, USING ONLY FIELDS ALREADY ON FILE.** **TCX market cap ₫114,007bn × 94.17% = ₫107,360bn.
  TCB's own market cap is ₫207,271bn. So TCB's stake in TCX is worth 51.8% of TCB's entire market
  capitalisation.** Against that, **TCX contributes 19.8% of TCB's TTM NPAT** (5,687 of 28,754) — which
  independently corroborates the 19.2% PBT share the look-through already used. **The cause is the multiple:
  TCX 20.05× against TCB 7.21× — a gap of 2.78×.** A subsidiary supplying a fifth of the earnings is worth half
  the parent because the market pays 2.78× the multiple for it.
  **AND THAT IS A METHODOLOGICAL ERROR IN THE LOOK-THROUGH'S OWN ESCALATION.** `effective_broker_pct.TCX` =
  12.23 is built as 5.5 direct + 35.0 × **19.2%** — **it uses an *earnings* share to scale a *portfolio
  weight*, and a portfolio weight is a market-value concept.** On the market-value share the indirect exposure
  is 35.0 × 51.8% = **18.13pp, so TCX is 23.63% of the book, not 12.23%.** **Total effective brokerage becomes
  30.95%, against the 19.54% that entry escalated and the 11.4% the cluster map states.** **Its headline —
  *"the cluster map understates industry concentration by 71%"* — is itself an understatement; the true figure
  against 11.4% is about 2.7×.** *VPX's 4.22 is left untouched because **VPB's ownership percentage of VPBankS
  is not established** — the same gap, one name over, now a named to-do rather than an invisible one.*
  **WHAT IT DOES TO THE PROPOSED TRADE, WHICH IS WHY IT IS ESCALATED.** The look-through says *"the optimizer's
  +5.1pp TCX add starts from an effective 12.2%… and would take broker exposure to ~25% of the book."* **On a
  market-value look-through it starts from ~23.6% and would take broker exposure to about 36% — against a 20%
  cluster cap.** **Not acted on** — optimizer config and cluster definitions are human-only under §4.
  **TWO READINGS OF THE 51.8%, AND I DO NOT CHOOSE.** *(a)* **TCX is expensive** at 20.05× and TCB's price
  simply does not capitalise the stake at TCX's own market price. *(b)* **TCB is cheap** — the residual bank,
  stripping the stake at market, is ₫99,911bn on ₫23,067bn of ex-TCX earnings, **4.33×**. **A tempting third
  argument is discarded here as tautological:** re-valuing the stake at TCB's *own* multiple makes the residual
  bank's multiple equal TCB's multiple — **an algebraic identity for any parent and subsidiary, not evidence.
  It looked like a confirmation and is not one.**
  **CAVEATS THAT MATTER.** Both caps rest on the file's **undated prices** (item 2); a common date error largely
  cancels in the **ratio** but not in the levels. TCX's cap depends on the corrected 2,773.9m count verified
  04-Aug. **The 94.17% is T5 press** and the same summary also says *"increased from 88.7% to 94%"* — 94.17 is
  used and the rounding is noted. **And the four pending share-count increases touch both sides:** TCB's 60%
  bonus is value-neutral for market cap, so the **ratio** survives it, but this should be re-run once prices are
  dated.
  *Also found, recorded not pursued: TCBS is establishing an **₫800bn subsidiary at the HCMC International
  Financial Centre**, and separately paid ~₫845m for **9.9% of a technology company**. And a date for the stale
  count: **TCX's 2,311,308,021 shares began trading 21-October-2025** — item 24 discussed that count without
  ever dating its listing.*
  **NOTHING MODELLED.** No weight, branch, probability, price or confidence moved. **The corrected look-through
...
- **09:20 ICT · MACRO (lane 1) — SBV drained ~₫330tn while the central rate hit an 11-week
  high, near its record.** Week 20–24 Jul: central rate +29 to **25,283** (vs the all-time
  25,298 of Aug-2025), 11th straight weekly rise; SBV has net-withdrawn ~₫330tn since early
  February; OMO rate held at **4.5%**; overnight interbank still calm at 2.97%. Press also
  flags a credit "crowding" effect — heavy corporate demand against constrained deposit
  supply. **Portfolio impact: confirms the funding-cost thesis for the 51.5% bank cluster
  (TCB/VPB/MBB) — NIM relief is not coming from policy; FX pressure is the new watch item.**
  [Thời báo Tài chính](https://thoibaotaichinhvietnam.vn/thi-truong-tien-te-tuan-20-24-7-ty-gia-trung-tam-sat-dinh-lich-su-ngan-hang-nha-nuoc-hut-rong-gan-330-000-ty-dong-201212.html) · [CafeF](https://cafef.vn/ngan-hang-nha-nuoc-hut-ve-hon-300000-ty-dong-188260720153933827.chn)

- **09:20 ICT · STEEL (lane 5) — HPG spread under visible pressure: Formosa cut HRC ~$40/t
  and iron ore has risen to ~$115/t.** Formosa Ha Tinh cut Aug/Sep-delivery HRC by
  **₫1,050/kg (≈US$40/tonne)**; Indian HRC offered ~US$535/t landed Vietnam; domestic HRC
  ~₫14,000–14,350/kg with import competition rising. Input side moved the wrong way: iron
  ore ~**US$115/t** (vs ~98–104 in our Q1 note), coking coal 2026 forecast raised to
  **US$220/t**. **Portfolio impact: this is exactly the HPG bear branch (the model's exposed
  variable is spread/tonne, not volume) — bear case ₫1.25m NPAT/tonne gains weight ahead of
  the official Q2 print.** [Tuổi Trẻ](https://tuoitre.vn/thep-hrc-trong-nuoc-giam-gia-truoc-suc-ep-hang-nhap-khau-100260713110833816.htm) · [VNSteel](https://vnsteel.vn/tin-thi-truong-thep/gia-xuat-khau-hrc-trung-quoc-tiep-tuc-tang-7556.html) · [Investing/Fitch](https://vn.investing.com/news/commodities-news/bat-chap-nhu-cau-thep-suy-yeu-fitch-van-nang-du-bao-gia-quang-sat-2642609)

- **09:20 ICT · No-change checks:** HPG, KDH and MBB official Q2/26 statements still
  unfiled (MBB's latest on file remains Q1 PBT ₫9,628bn, +14.8%); US rebar AD/CVD **final
  determination not yet published** in the Federal Register (still expected ~Jul 28, CVD
  aligned to the same date); no new TCB/VPB/MBB ex-dates; no CAEX licence decision.
...
- **16:20 ICT · VPB — capital-raise method changed (shareholder consultation out).**
  VPBank is collecting written shareholder opinions to amend the phase-1/2026
  capital increase: switching from a bonus issue funded by equity reserves to a
  **26% stock dividend paid from undistributed retained earnings**; charter capital
  still targeted at ₫100tn, execution still Q2–Q3 with completion Q3–Q4, foreign
  placement unchanged. Portfolio impact: mechanics only for holders (26% more
  shares, price adjusts on ex-date — same dilution math as before); watch for the
  record date once shareholder approval closes.
  [Vietstock](https://vietstock.vn/2026/07/vpbank-lay-y-kien-co-dong-thay-doi-phuong-an-tang-von-dieu-le-sang-tra-co-tuc-bang-co-phieu-ty-le-26-757-1463767.htm) · [Vietnambiz](https://vietnambiz.vn/vpbank-muon-thay-doi-phuong-an-tang-von-sang-tra-co-tuc-bang-co-phieu-ty-le-26-202677115440615.htm)
- **16:20 ICT · No-change checks:** US rebar AD final still on calendar for Jul 28
  (no early release found); HPG and KDH 2Q26 financial statements not yet published;
  no new SBV rate/OMO/quota action dated today; no TCB bonus-issue ex-date announced yet.
- **(baseline)** Log initialized after the v2 deep-dive (commit 73545b7). Current
  state summarized in `portfolio-ticker-research-2026.md`; catalyst calendar there
  is the reference for expected events.
