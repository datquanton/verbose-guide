...
This round does two things:
  ...
  Model!Y278     the specific charge / write-off ratio, 0.85x -> 0.8802x, to
                 set FY26F PBT at VND8,150bn - marginally above the ~VND8,100bn
                 board-approved plan.  Coverage goes to 51.0% from 50.0%; NPL
                 and CIR are untouched.
...
MODEL_EDITS = {
    'Y278': ('-Y279*0.85', '-Y279*0.8802', 'specific charge -> PBT VND8,150bn'),
...
PROV = {26: 11446.9, 27: 8228.8, 28: 5816.0}            # Model!Y254, FY26F re-solved
RESERVE = {26: 19329.5, 27: 20059.4, 28: 20923.2}       # Model!Y286, +356.2 carried
