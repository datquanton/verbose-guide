...
BLOCKS = [
 dict(tick='stb', lang='en', sector='Banks',
      ...
      t4='Estimates',
      sub2='FY26F: PBT -1.7%, CIR 42.0%, NPL 5.8%',
      ...
      points=[
        ...
        ('FY26F PBT VND7,500bn (-1.7% YoY), 7% below plan',
         ...
         '1H26. NII falls to VND24,570bn, then recovers 15% in FY27F. CIR 42% flat.'),
        ('HOLD, target price VND75,000',
         'The recovery sits in FY28F, when PBT reaches VND16,448bn (+50%) on a cleaned '
      ...
      rows=[('NII (VNDbn)', ['26,681', '24,570', '24,388', '27,512']),
            ...
            ('Operating profit (VNDbn)', ['7,628', '7,500', '10,953', '16,448']),
            ('NP (VNDbn)', ['5,939', '5,840', '8,528', '12,806']),
            ('EPS (VND)', ['2,883', '2,834', '4,139', '6,216']),
            ('ROE (%)', ['10.3', '8.9', '12.2', '15.9']),
            ('P/E (x)', ['26.0', '26.5', '18.1', '12.1']),
            ('P/B (x)', ['2.6', '2.3', '2.1', '1.8'])]),
 dict(tick='stb', lang='vn', sector='Ngân hàng',
      ...
      sub2='FY26F: LNTT -1.7%, CIR 42.0%, nợ xấu 5.8%',
      ...
      points=[
        ...
        ('LNTT FY26F 7,500 tỷ đồng (-1.7% CK), thấp hơn kế hoạch 7%',
         ...
         '1H26. NII còn 24,570 tỷ đồng, hồi phục 15% năm FY27F. CIR giữ 42%.'),
        ('NẮM GIỮ, giá mục tiêu 75,000 đồng',
         'Đà hồi phục dời sang FY28F, khi LNTT đạt 16,448 tỷ đồng (+50%) trên nền dư nợ đã sạch. Chi phí 2H26 cao hơn nửa đầu năm 5.6% — không giả định cắt giảm.')],
      rows=[('Thu nhập lãi thuần (tỷ đồng)', ['26,681', '24,570', '24,388', '27,512']),
            ('Thu nhập ngoài lãi (tỷ đồng)', ['5,376', '5,950', '7,226', '8,517']),
            ('LNHĐ (tỷ đồng)', ['7,628', '7,500', '10,953', '16,448']),
            ('LNST (tỷ đồng)', ['5,939', '5,840', '8,528', '12,806']),
            ('EPS (đồng)', ['2,883', '2,834', '4,139', '6,216']),
            ('ROE (%)', ['10.3', '8.9', '12.2', '15.9']),
            ('P/E (lần)', ['26.0', '26.5', '18.1', '12.1']),
            ('P/B (lần)', ['2.6', '2.3', '2.1', '1.8'])]),
