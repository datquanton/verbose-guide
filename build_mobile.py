 ...
 dict(tick='stb', lang='en', sector='Banks',
      ...
      points=[
        ...
        ('FY26F PBT VND7,461bn (-2.2% YoY), 8% below plan',
         ...
         '1H26. NII falls to VND24,531bn, then recovers 9.9% in FY27F. CIR 42.1%.'),
        ('HOLD, target price VND75,000',
         'The recovery sits in FY28F, when PBT reaches VND15,170bn (+57%) on a cleaned '
      ...
      rows=[('NII (VNDbn)', ['26,681', '24,570', '24,388', '27,512']),
            ...
            ('Operating profit (VNDbn)', ['7,628', '7,461', '9,642', '15,170']),
            ('NP (VNDbn)', ['5,939', '5,809', '7,507', '11,811']),
            ('EPS (VND)', ['2,883', '2,820', '3,644', '5,733']),
            ('ROE (%)', ['10.3', '8.8', '10.8', '14.9']),
            ('P/E (x)', ['26.0', '26.6', '20.6', '13.1']),
 ...
 dict(tick='stb', lang='vn', sector='Ngân hàng',
      ...
      points=[
        ...
        ('LNTT FY26F 7,461 tỷ đồng (-2.2% CK), thấp hơn kế hoạch 8%',
         ...
         '1H26. NII còn 24,531 tỷ đồng, hồi phục 9.9% năm FY27F. CIR 42.1%.'),
        ('NẮM GIỮ, giá mục tiêu 75,000 đồng',
         'Đà hồi phục dời sang FY28F, khi LNTT đạt 15,170 tỷ đồng (+57%) trên nền dư nợ đã sạch. Chi phí 2H26 cao hơn nửa đầu năm 5.6% — không giả định cắt giảm.')],
      rows=[('Thu nhập lãi thuần (tỷ đồng)', ['26,681', '24,570', '24,388', '27,512']),
            ('Thu nhập ngoài lãi (tỷ đồng)', ['5,376', '5,950', '7,226', '8,517']),
            ('LNHĐ (tỷ đồng)', ['7,628', '7,461', '9,642', '15,170']),
            ('LNST (tỷ đồng)', ['5,939', '5,809', '7,507', '11,811']),
            ('EPS (đồng)', ['2,883', '2,820', '3,644', '5,733']),
            ('ROE (%)', ['10.3', '8.8', '10.8', '14.9']),
            ('P/E (lần)', ['26.0', '26.6', '20.6', '13.1']),
