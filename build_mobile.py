...
BLOCKS = [
 dict(tick='stb', lang='en', sector='Banks',
      ...
      t4='Estimates',
      sub2='FY26F: PBT -7.2%, CIR 42.8%, NPL 5.5%',
      ...
      points=[
        ...
        ('NPL 7.54% at end-2Q26, the highest in the system',
         ...
         'Group 5.'),
        ('We set FY26F NPL at 5.5%, coverage at 54%',
        ...
        ('FY26F PBT VND7,082bn (-7.2% YoY), 13% below plan',
         'We cut FY26F loan growth to 2.3% from 11.7%, in line with the 1.5% delivered in '
         '1H26. NII falls to VND24,570bn and CIR rises to 42.8%.'),
        ('HOLD, target price VND81,400',
         'The recovery now sits in FY28F, when PBT reaches VND13,882bn on a cleaned book.')],
      rows=[('NII (VNDbn)', ['26,681', '24,570', '24,388', '27,512']),
            ('Non-II (VNDbn)', ['5,376', '5,950', '7,226', '8,517']),
            ('Operating profit (VNDbn)', ['7,628', '7,082', '7,949', '13,882']),
            ('NP (VNDbn)', ['5,939', '5,514', '6,189', '10,808']),
            ('EPS (VND)', ['2,883', '2,676', '3,004', '5,246']),
            ('ROE (%)', ['10.3', '8.4', '9.0', '14.0']),
            ('P/E (x)', ['28.2', '30.4', '27.1', '15.5']),
 ...
 dict(tick='stb', lang='vn', sector='Ngân hàng',
      ...
      sub2='FY26F: LNTT -7.2%, CIR 42.8%, nợ xấu 5.5%',
      ...
      points=[
        ...
        ('Đặt giả định nợ xấu FY26F ở 5.5%, bao phủ 54%',
         ...
         'phải lợi nhuận.'),
        ('LNTT FY26F 7,082 tỷ đồng (-7.2% CK), thấp hơn kế hoạch 13%',
         'Hạ tăng trưởng tín dụng FY26F về 2.3% từ 11.7%, ngang mức 1.5% thực hiện trong '
         '1H26. NII còn 24,570 tỷ đồng và CIR lên 42.8%.'),
        ('NẮM GIỮ, giá mục tiêu 81,400 đồng',
         'Đà hồi phục dời sang FY28F, khi LNTT đạt 13,882 tỷ đồng trên nền dư nợ đã sạch.')],
      rows=[('Thu nhập lãi thuần (tỷ đồng)', ['26,681', '24,570', '24,388', '27,512']),
            ('Thu nhập ngoài lãi (tỷ đồng)', ['5,376', '5,950', '7,226', '8,517']),
            ('LNHĐ (tỷ đồng)', ['7,628', '7,082', '7,949', '13,882']),
            ('LNST (tỷ đồng)', ['5,939', '5,514', '6,189', '10,808']),
            ('EPS (đồng)', ['2,883', '2,676', '3,004', '5,246']),
            ('ROE (%)', ['10.3', '8.4', '9.0', '14.0']),
            ('P/E (lần)', ['28.2', '30.4', '27.1', '15.5']),
            ('P/B (lần)', ['2.8', '2.6', '2.3', '2.0'])]),
