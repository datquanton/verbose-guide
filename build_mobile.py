...
BLOCKS = [
 dict(tick='stb', lang='en', sector='Banks',
      ...
      t4='Estimates',
      sub2='FY26F: PBT -1.7%, CIR 40.0%, NPL 5.5%',
      ...
      points=[
        ...
        ('NPL 7.54% at end-2Q26, the highest in the system',
         ...
         'Group 5.'),
        ('We set FY26F NPL at 5.5%, coverage at 55%',
        ...
        ('FY26F PBT VND7,500bn (-1.7% YoY), 7% below plan',
         'We cut FY26F loan growth to 2.3% from 11.7%, in line with the 1.5% delivered in '
         '1H26. NII falls to VND24,570bn; CIR held at 40.0%, easing to 38% and 36%.'),
        ('HOLD, target price VND81,400',
         'The recovery sits in FY28F, when PBT reaches VND16,076bn on a cleaned book. '
         'Holding CIR at 40% needs 2H26 costs 4.1% below the first half.')],
      rows=[('NII (VNDbn)', ['26,681', '24,570', '24,388', '27,512']),
            ('Non-II (VNDbn)', ['5,376', '5,950', '7,226', '8,517']),
            ('Operating profit (VNDbn)', ['7,628', '7,500', '9,973', '16,076']),
            ('NP (VNDbn)', ['5,939', '5,839', '7,765', '12,516']),
            ('EPS (VND)', ['2,883', '2,834', '3,769', '6,075']),
            ('ROE (%)', ['10.3', '8.9', '11.1', '15.7']),
            ('P/E (x)', ['28.2', '28.7', '21.6', '13.4']),
            ('P/B (x)', ['2.8', '2.6', '2.3', '1.9'])]),
 dict(tick='stb', lang='vn', sector='Ngân hàng',
      ...
      sub2='FY26F: LNTT -1.7%, CIR 40.0%, nợ xấu 5.5%',
      ...
      points=[
        ...
        ('Đặt giả định nợ xấu FY26F ở 5.5%, bao phủ 55%',
         ...
         'phải lợi nhuận.'),
        ('LNTT FY26F 7,500 tỷ đồng (-1.7% CK), thấp hơn kế hoạch 7%',
         'Hạ tăng trưởng tín dụng FY26F về 2.3% từ 11.7%, ngang mức 1.5% thực hiện trong '
         '1H26. NII còn 24,570 tỷ đồng; CIR giữ 40.0%, giảm dần về 38% và 36%.'),
        ('NẮM GIỮ, giá mục tiêu 81,400 đồng',
         'Đà hồi phục dời sang FY28F, khi LNTT đạt 16,076 tỷ đồng trên nền dư nợ đã sạch. '
         'Giữ CIR 40% đòi hỏi chi phí 2H26 thấp hơn nửa đầu năm 4.1%.')],
      rows=[('Thu nhập lãi thuần (tỷ đồng)', ['26,681', '24,570', '24,388', '27,512']),
            ('Thu nhập ngoài lãi (tỷ đồng)', ['5,376', '5,950', '7,226', '8,517']),
            ('LNHĐ (tỷ đồng)', ['7,628', '7,500', '9,973', '16,076']),
            ('LNST (tỷ đồng)', ['5,939', '5,839', '7,765', '12,516']),
            ('EPS (đồng)', ['2,883', '2,834', '3,769', '6,075']),
            ('ROE (%)', ['10.3', '8.9', '11.1', '15.7']),
            ('P/E (lần)', ['28.2', '28.7', '21.6', '13.4']),
            ('P/B (lần)', ['2.8', '2.6', '2.3', '1.9'])]),
