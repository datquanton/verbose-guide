...
**Updated 07-Aug 00:53 ICT.** *(00:53 — **§9's oldest open question gets an answer on the ore leg, and the price move itself is noise.** **THE BASIS:** the iron-ore series this file has used throughout is **62% Fe, CFR (cost and freight) delivered TIANJIN** — `hpg-spread-bridge.md` §9 has said since creation that *no price in the bridge has a stated delivery basis*, and with coal pinned at **US$228 FOB Australia** on 06-Aug, **both legs are now pinned.** **It also retroactively confirms the withdrawal:** the 05-Aug 09:53 entry set a **61% Fe** quote against the file's 93.66 and was withdrawn 06-Aug 10:53 on a consistency check — **the basis being 62% Fe means it was the wrong grade, exactly as claimed.** **THE PRICE MOVE IS NOISE AND IS REPORTED AS NOISE:** ore **93.91 on 05-Aug (+0.22%)** vs the file's 93.66 = **+$0.25/t → ₫8,500/tonne → ₫98bn → 0.36% of base FY NPAT.** **For scale: the arithmetic error withdrawn on 06-Aug was ~₫22,000/t, nearly three times larger.** **BOTH GEARINGS RECONSTRUCT, AND THEIR TAX BASIS WAS UNDOCUMENTED:** 1.6 × $10 × ₫26,400 × 0.8 = **₫0.338m** vs the stated ₫0.34m, and 0.65 × $10 × ₫26,400 × 0.8 = **₫0.137m** vs ₫0.14m — **they are AFTER-TAX NPAT sensitivities at 20% CIT, written down nowhere; applying them to PBT overstates every spread conclusion by 25%.** **⚠ §9 IS STILL NOT CLOSED:** ore is CFR **Tianjin**, coal is FOB **Australia**, and HPG smelts at **Dung Quat** — the ore leg embeds Australia→China freight where the bridge needs Australia→Vietnam. **Named, not sized.** **Nothing modelled; no confidence moved; no trigger fires.** *Today: **US July payrolls 19:30 ICT**, the direct test of the 05-Aug pre-registration after claims scored a miss. **MBB ex-rights 11-Aug is 3 sessions.***)*
