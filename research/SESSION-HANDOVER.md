...
**Updated 07-Aug 22:53 ICT.** *(22:53 — **a smaller hour than the last several, and said so.** **Session, recorded as environment:** VN30 **+0.44% to 1,911.09**, turnover ₫17,048bn, breadth 207/87/162; **foreign net selling across all three exchanges only ₫90bn** but concentrated — **VHM ₫282.51bn · TCB ₫218.93bn · VPB ₫204.68bn · VIC ₫152.5bn · FPT ₫53.61bn.** **The arithmetic says ROTATION, not exit:** those five total **₫912.23bn** against a **−₫90bn** net, implying **~₫822bn of net foreign BUYING elsewhere.** **⚠ And it is still noise for this book: TCB's and VPB's sells are each 0.103% of market cap** — together **2.5% of the whole market's turnover on 45% of the book, striking as a share of the tape, immaterial as a share of the companies**, and one session besides. **⚠⚠ THE DURABLE ITEM IS A CORRECTION TO MY OWN AUDIT: TCX's armed "no net foreign accumulation in the 4 weeks after Sep 21" was filed at 07:53 as CONDITIONAL because the source was "blocked here" — per-ticker foreign flows are published daily, so it is PENDING-WINDOW, not pending-source.** **Second time today a "blocked" verdict of mine was too strong** (item 2 at 02:53, walked back 11:53). ***I have been inferring "the data is unavailable" from "the page I tried is 403" — a blocked host is evidence about a host, not about a number.*** **Nothing modelled; no confidence moved; no trigger fires — the 14:53 trigger-3 and 06-Aug trigger-5 escalations stand, and MBB's last cum session is MONDAY 10-Aug.**)*
