...
**Updated 06-Aug 21:53 ICT.** *(21:53 — **the two brokers this book owns are Vietnam's two biggest share gainers, and that makes item 8 WORSE, not better.** Q2/2026 HOSE market share, a quantity the file tracked the *margin* league for and **never held at all**: VPS 12.61% (22-quarter low, still #1) · SSI 11.17% · **TCBS 9.36% (+0.51pp, all-time high)** · **Vietcap 7.00%** · HSC 6.80% · MBS 4.79% · VNDirect 3.96% (−0.82pp, multi-year low) · **VPBankS 3.57% (+0.63pp, largest gain in the top ten, a company record)** · KIS 2.99% · Mirae 2.94%. **Checked before use: the ten sum to 65.19% against a separately-reported ">65%".** **The bank-affiliated brokers are taking share from the independents.** **⚠ AND THE INSTINCT THAT INVITES IS BACKWARDS:** item 8 carries brokerage at **31.53%** with the optimizer proposing **+5.1pp more TCX → ~36% against a 20% cap**, and 'both our names are winning' reads as quality. **They win for the SAME reason — bank distribution — which is evidence of MORE correlation, not less. A cap prices covariance, not quality. This strengthens the cap and weakens the add.** **Scale: the book's three brokers are 19.93% of HOSE turnover**, 12.93pp of it the two bank-affiliated names. **⚠ It does NOT test VCI's criterion** — that test is *foreign* brokerage share, this is *total*; **untested, not passed** — and **7.00% does not contradict the file's ">28% institutional share"**, since HOSE turnover is retail-dominated. **VCI's direction is NOT established** and was not inferred; the retiring field is its Q1/2026 HOSE share. *Vintage stated up front: the source is 06–07 July — a backfill of a quantity the file never held, not a new development.* **Nothing modelled, no confidence moved, no escalation trigger fires.** New item 41.)*
