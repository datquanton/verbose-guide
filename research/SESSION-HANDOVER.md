...
**Updated 07-Aug 03:53 ICT.** *(03:53 — **the CORE gate is DERIVED rather than trusted, gets a statutory OUTER BOUND for the first time, and a THIRD circumvention inquiry surfaces that the file does not hold.** **19 CFR 351.226** sets the preliminary at **150 days from the 25-Mar initiation = Saturday 22-Aug, rolling to Monday 24-Aug** — **the file's date is right, and right for a reason it never recorded**; a future sweep computing 150 days would have got 22-Aug and "found" an error that isn't one. **⚠ THE OUTER BOUND:** the same rule sets the **final at 300 days** with a **65-day maximum extension** — **19-Jan-2027, ceiling 25-Mar-2027. This gate can slip seven months lawfully**, so 24-Aug is an intention, not a decision point. *(Same species as the 27-Oct-2026 bound on Decision 612.)* **⚠ A THIRD INQUIRY, NAMED AND DELIBERATELY NOT CHARACTERISED: FR 2026-13607, published 06-Jul-2026, on the CHINA CORE orders** — distinct from the two March documents (FR 2026-05808 Vietnam, FR 2026-05807 Chinese substrate via Indonesia); its 150-day preliminary would fall **03-Dec-2026**. **Only the title and date are in hand.** The tempting inference — that Vietnam is the finishing country, which would make this a **direct** exposure running **opposite** to the March case — **is logged as a possibility, not a finding**, with the resolving field named (the third-country scope in FR 2026-13607; `federalregister.gov` is gateway-blocked). **No change to HPG:** rebar is ~3% of revenue, the March inquiry is country-wide with no Vietnamese producer named, and **HPG makes HRC, not CRS.** *US close deferred to 04:53 — it was 54 minutes old, exactly at the file's measured indexing boundary, per the 03-Aug precedent.* **Nothing modelled; no confidence moved; no trigger fires.**)*
