...
**Updated 07-Aug 04:53 ICT.** *(04:53 — **the open item created one hour ago is CLOSED, and it closes against the inference I declined to make.** **FR 2026-13607 covers CORE from China completed in THAILAND using Chinese components — Vietnam is not involved.** At 03:53 I logged that Vietnam is historically the principal route for Chinese CORE and that a Vietnam scope would mean a **direct** exposure running opposite to the March case — *"a possibility, not a finding"*. **The base rate pointed at Vietnam; the answer is Thailand.** Asserting it would have meant a false direct trade exposure on a **16.8%** position and a fourth withdrawal this week. **Named with the resolving field stated, closed one hour later, no correction needed.** **THE MAP IS COMPLETE — THREE INQUIRIES, ONE TOUCHES VIETNAM:** FR 2026-05808 (25-Mar, Vietnam CORE orders, Indonesia-from-Vietnamese-CRS, prelim **24-Aug**, final 19-Jan-2027, ceiling 25-Mar-2027) · FR 2026-05807 (25-Mar, Chinese substrate via Indonesia) · FR 2026-13607 (06-Jul, Thailand-from-Chinese, prelim ~03-Dec-2026, **Vietnam absent**). **Only the first involves Vietnam, and as substrate origin rather than finisher — and HPG makes HRC, not CRS, so even that is second-order. No change to HPG on any of the three.** **A pattern named, a forward inference declined:** Nucor and Steel Dynamics requested all three and all three attack third-country routing — **a campaign, and a fact** — but whether it implies a future Vietnam-as-finisher case is **speculation about filings that do not exist and is not logged as risk.** **US CLOSE, read at 114 minutes as pre-registered:** Dow **−0.9%** (record streak snapped), S&P −0.2%, Nasdaq −0.1%, **yields up — reversing the three-day decline logged 05-Aug, with no level given and none invented.** **Noise by this file's own standard; recorded as environment.** **Nothing modelled; no confidence moved; no trigger fires.**)*
