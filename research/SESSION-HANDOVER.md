...
**Updated 08-Aug 04:53 ICT.** *(04:53 — **US close read at 114 minutes as pre-registered, and it CORRECTS the mechanism I wrote nine hours ago.** **S&P +0.62% to 7,757.64 — a RECORD HIGH — on a −23,000 payroll print**; Dow +0.28%, Nasdaq +1.30%; week S&P +3.58%. **Yields fell: 10y −1bp to 4.654%, 2y −4bp to 4.204%; DXY −0.3% to 99.60** (99.85 on 05-Aug). **⚠⚠ THE CORRECTION: at 19:53 I wrote the miss *"raises Fed-CUT expectations."* The coverage says three separate times that it reduced the odds of a **HIKE** — and the levels agree, a 2y of 4.204% under a 10y of 4.654% being an upward-sloping curve with no easing priced.** **The market did not price cuts; it priced the removal of a hike. The dollar fell either way, so the DIRECTION was right and the MECHANISM was not — recorded as a failure, per this file's own convention.** **⚠ And the consequence is not cosmetic: "SBV gains room to cut" does NOT follow from "the Fed is less likely to hike" — the constraint STOPS TIGHTENING, it does not loosen.** *The cutting-cycle framing appears in the 05-Aug 22:53 DXY note and at 19:53 yesterday; both should be read with this correction attached.* **The regime, named: an equity record high on a contracting payroll print is "bad news is good news" — equities rallied because the hike went away while the 10y still sits at 4.654%. A not-tightening environment, not an easing one, and the two differ for bank margins and EM FX.** **Still environment, not evidence; nothing modelled; no confidence moved; no trigger fires — the 14:53 trigger-3 and 06-Aug trigger-5 stand. MBB'S LAST CUM SESSION IS MONDAY 10-AUG.**)*
