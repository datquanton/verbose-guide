...
**Updated 07-Aug 06:53 ICT.** *(06:53 — **⚠⚠ HIGHEST-PRIORITY HUMAN CALL ON THE BOARD. KDH's armed "earnings quality stays synthetic" criterion cannot be adjudicated, and its two natural readings give OPPOSITE answers on 20.3% of the book.** **The mechanism, new to the file (`896` appeared nowhere):** KDH transferred **2% of Bình Trưng Mới on 23-Jun-2026 for ₫68bn and booked >₫896bn of financial revenue** — a remeasurement on loss of control, not a gain on the 2%. **Q2 NPAT ₫770bn (₫750bn parent), a company record, with property revenue at a four-year low and house sales −85%.** **Q1 is unambiguous and on file:** 355.7 − 285.2 = **₫70.5bn operating PBT, gain 4.05× — MET.** **Q2 turns entirely on the undefined term:** **Reading A** (PBT minus gain) gives operating PBT **−₫126bn to +₫79bn** across a 0–21% tax rate and **the gain exceeds it on every assumption — MET, robustly** (escape needs NPAT >~₫1,416bn vs ₫770bn actual); **Reading B** (*lợi nhuận thuần từ HĐKD*, which **includes** financial income) gives ~₫975bn and **₫896bn does NOT exceed it — NOT MET.** **⚠ NOT DECLARED FIRED** — declaring a trigger-1 escalation on a reading I chose myself, when the other is at least as natural under Vietnamese GAAP, is the worst error available. **Define "operating PBT" and the criterion answers itself; Q1 is met under both readings, so the whole question is Q2.** **⚠ A THIRD SUCH QUARTER IS CONTRACTED:** total transfer **>₫1,743bn**, only **₫68bn** received, **full 51% due by Q3/2026** — landing on the same quarter as the *other* armed criterion (*customer advances < ₫1,000bn at 3Q26*), **two criteria on one quarter from opposite directions.** *Sharpens item 32.* **Seventh defective criterion, and the first where the defect changes an answer rather than preventing one.** **Nothing modelled; no criterion status changed; no confidence moved (T5 press, not the filing).** New item 43.)*
