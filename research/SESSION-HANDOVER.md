...
**Updated 08-Aug 03:53 ICT.** *(03:53 — **⚠⚠ went to update HPG's coal leg and found the file's OWN note does not reconcile.** The bridge note titled ***"BOTH INPUTS VERIFIED"*** says *"SPOT 228 (PHCC FOB Australia, −24% MoM from 238.9 on 10-Jul) vs 220 modelled"* — **238.9 → 228 is −4.56%, and −24% from 238.9 lands at 181.6. Level, base and percentage disagree.** **Four coal figures now circulate: 220 modelled · 228 spot (06-Aug) · 212 (03-Aug, basis unstated) · 241 (Peak Downs single-brand bid).** **⚠ The 241 is REFUSED — the identical trap withdrawn on 06-Aug 11:53, same brand, same price, three days later.** **⚠ And the 212 is not used either: 212 on 03-Aug against a 228 pinned 06-Aug as "down an eighth consecutive week" implies coal ROSE into the pin — one is stale or differently based, and nothing establishes which.** *The tempting delta was −$16/t = +₫2,576bn = +9.4% of FY NPAT; it is NOT computed, because this is the 09:53-06-Aug failure exactly.* **THE FINDING IS THE SPREAD: $212–$241 = $29/t → ₫0.406m per tonne = 22.5% of Q2's ₫1.803m/t, or ₫4,669bn = 17.0% of base-case FY NPAT. The named "live variable" of a 16.8% position is known only to within 17% of that position's annual earnings.** **What closes it: one dated PHCC FOB Australia index print with its assessment DATE and UNIT — every figure above is missing at least one of the three.** *§9 was partly answered Friday by pinning the basis; today shows a basis without a date and a unit is still not an input.* **Nothing modelled; bridge inputs untouched (§4); no confidence moved; no trigger fires — the 14:53 trigger-3 and 06-Aug trigger-5 stand. MBB'S LAST CUM SESSION IS MONDAY 10-AUG.** New item 46.)*
