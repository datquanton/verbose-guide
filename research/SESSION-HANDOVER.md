...
**Updated 07-Aug 15:53 ICT.** *(15:53 — **seven of eight names now measured, 94.5% of the book, and VPB's gap is the smallest yet.** **VPB closed ₫25,150 on 03-Aug**, cap **₫199,538.2bn**, dividing to **7,933,924,453 shares vs the file's 7,933,900,000 — +0.0003%.** **The file is 0.60% below**; E[r] moves **−13.86% → −14.37%, just −0.51pp. Trigger 3 does not fire and is not close.** **FULL TALLY: HPG −7.76% · MBB −7.74% · TCB −2.34% · KDH +1.1% · VPB −0.60% · VCI bracketed · VPX 12-Jun. Only TCX (5.5%) unmeasured.** **⚠ THE SHAPE, now that it is nearly complete: the gaps are NOT uniform, do NOT share a sign, and are NOT a function of size** — largest on HPG and MBB, smallest on VPB and KDH, TCB in between. **A single index-based adjustment (what the 01:53 conditional proposed) would have been wrong on every name individually, and only ONE name's error clears the threshold.** **⚠ A UNIT ERROR CAUGHT, GIVING THE METHOD A THIRD GUARD:** the same source quotes VPB's 07-Aug cap as *"196,76 tỷ đồng"* — literally ₫196.76bn, implying **₫24.80 per share.** **Guard 3: is the implied price plausible?** — alongside **guard 1 (=₫10,000 → par)** and **guard 2 (reproduces the share count)**. *Two of the three were found by being wrong first.* **The corrected ₫196,760bn would be TODAY's cap — the freshest datum available — but the repair is MINE, not the source's, so it is recorded as author-corrected and EXCLUDED from the tally.** **Nothing modelled; every field guarded §4; no confidence moved; no trigger fires this hour — the MBB trigger-3 escalation from 14:53 stands.**)*
