...
**Updated 07-Aug 20:53 ICT.** *(20:53 — **⚠⚠ THE MBB RIGHTS ARE TRANSFERABLE, AND THAT CORRECTS MY OWN 06-Aug 18:53 FRAMING ON THE LIVE TRIGGER-5 ITEM.** **Transfer window 18–26 Aug**, inside the subscription window 18-Aug–07-Sep; no minimum subscription; **it appeared nowhere in the file.** **That entry said "fund it or the holding is diluted" — a false dichotomy: a holder who won't add capital can SELL the rights.** **And the third option has a price:** no-arbitrage on the entitlement (1 share = 1 right, 10 rights buy 1 share at ₫10,000) against the dated ₫23,900 close gives **1.15P + 0.1(P−10,000) = 23,900 ⇒ P = ₫19,920**, so **each right is worth ₫992 — 4.15% of the cum price**; the balance closes exactly (1.15 × 19,920 + 992 = 23,900). **⚠⚠ And ₫19,920 matches the 14:53 cap-method TERP to the dong — two independent CONSTRUCTIONS, not two sources.** **⚠ HARD DATE: transfer closes 26-Aug, subscription runs to 07-Sep — the ₫992 expires twelve days before the cash call does**, and that asymmetry was not in the file. *E[r] arithmetic unchanged: the post-money ₫200,569.5bn and the −15.64pp at 14:53 assume exercise, which stays the base case. What changes is the holder's decision — three branches, not two.* **Dates now complete: ex-rights 11-Aug (last cum session MONDAY 10-Aug) · record 12-Aug · transfer 18–26 Aug · subscription 18-Aug–07-Sep.** **Nothing modelled; all fields guarded §4; no confidence moved; no NEW trigger — the 14:53 trigger-3 and 06-Aug trigger-5 escalations both stand.**)*
