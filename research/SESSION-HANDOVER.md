...
**Updated 07-Aug 14:53 ICT.** *(14:53 — **⚠⚠⚠ ESCALATION TRIGGER 3 FIRES ON MBB, and I must correct a claim I made three hours running.** **MBB closed ₫23,900 on 06-Aug**, cap **₫192,514.5bn**, dividing to **8,055,000,000 shares — EXACT, to the unit**; **HPG ₫22,550 on 03-Aug**, cap **₫190,388.8bn**, −0.0004%. **The file is 7.74% and 7.76% BELOW.** **⚠ THE CORRECTION: at 11:53, 12:53 and 13:53 I wrote that every measured gap was under 2.5%. True of TCB, KDH and VCI — FALSE as a general claim, and it breaks on the two large names I had not yet measured, one of them the engine's #1.** **⚠⚠⚠ MBB: raw +36.69% → +26.11%, −10.58pp — CLEARS THE 10pp THRESHOLD.** Shrunk +18.34% → +13.05%. *(Engine reproduced exactly first.)* **This is a STALE-INPUT CORRECTION, not a market move — E[r] did not fall, it was overstated for fourteen days — but that is precisely what trigger 3 exists to surface.** **Compounding: + 11-Aug rights → +21.04% (−15.64pp); + crediting item 3's 4.54% cash yield → +25.58% (−11.10pp NET). Even after giving MBB the yield it is owed, the net still clears** — the trigger does not depend on which defect is fixed first. **HPG: +6.38% → −1.88% (−8.26pp) — trigger 3 does NOT fire, stated rather than stretched, but a positive E[r] turns NEGATIVE on 16.8% of the book.** *Ranking order survives (MBB stays #1); magnitude does not — conviction on the largest add is roughly a third smaller than the brief states.* *Also updates 18:53: MBB's theoretical ex-all price is **₫19,920**, not ₫18,440 — though the post-ex trap stays exactly −20.0%, being structural.* **ITEM 2 NOW MEASURED ON SIX OF EIGHT — 83.5% of the book. Unmeasured: VPB 10.0%, TCX 5.5%.** **Nothing modelled; every field involved is guarded §4; no confidence moved.**)*
