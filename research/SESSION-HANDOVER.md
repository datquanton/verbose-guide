...
**Updated 06-Aug 17:53 ICT.** *(17:53 — **the bank cross-section is COMPLETE and it settles the sign of the owner's standing instruction.** **VPB NPL coverage = 56.2%** (reserve ₫21,395bn / NPLs ₫38,087bn), the last missing cell, **triple cross-checked against the file's own loan balances by three independent routes** — while the source's paired *"52.8% previous quarter"* was **REFUSED**, because 0.528 is already on file as VPB's prior-year provisioning intensity, a different quantity. Level established; **direction not established and not used.** **FULL TABLE — flow / stock: VCB 2.05% / 279% · TCB 8.0% / 125.5% · MBB 27.6% / 93.63% · VPB 45.2% / 56.2%.** The instruction was *watch provisions and LLR because banks might be managing earnings*; **its usual heuristic — low provisioning is suspicious — is backwards.** Low flow is the *consequence* of a heavy stock; high flow is the *running cost* of a thin one. **The detector that works is the pair (light flow AND thin stock), and none of the four qualifies; the name nearest the danger quadrant is MBB.** *The monotone ordering is NOT offered as evidence — the definitions imply it.* **SIZING, and it is the largest number this book has produced: closing VPB to merely 100% costs ₫16,692bn = 40.1% of the full-year PBT target** — a balance-sheet item an order of magnitude larger than every P&L item chased since 02-Aug. **⚠ It is an UPPER BOUND** — FE Credit is 39.5% of group provisions on a book priced for loss, and VPB-ex-FE-Credit cannot be computed here. **AND THE SAME ARITHMETIC FOUND A SIXTH DEFECTIVE ARMED CRITERION, the first of the opposite type:** VPB's *">3.0% credit cost"* on FE Credit needs a book above **₫410,533bn (35.4% of consolidated loans)** for the test *not* to be firing. Five prior defects **could not fire**; this one **cannot help but fire**. **Six of six examined are defective — the rate is the finding.** Not declared fired; the balance is not held here. **One field — FE Credit's own NPL and loan balances, due 29-Aug — unblocks both.** Nothing modelled, no confidence moved, no trigger fired. New items 36, 37.)*
