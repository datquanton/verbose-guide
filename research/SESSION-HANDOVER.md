...
**Updated 07-Aug 16:53 ICT.** *(16:53 — **✅ EIGHT OF EIGHT. The price-measurement programme is complete.** **HPG −7.76% · MBB −7.74% · TCB −2.34% · TCX −0.73%/+1.36% (undated) · KDH +1.1% · VPB −0.60% · VCI bracketed · VPX 12-Jun.** **Six of eight gaps under 2.5%; two near −7.8%; signs mixed; size does NOT predict the error; and EXACTLY ONE correction clears the escalation threshold — MBB, −10.58pp, raised at 14:53 and unchanged.** **The 01:53 conditional's single index-based adjustment would have mis-stated all eight and flagged the wrong names.** **⚠ TCX's guard-2 check FAILED at 2.10% and then passed** — the cap is struck at the prior close (**₫41,400**) and the price quoted after a −2.05% move (**₫41,400 × 0.9795 = ₫40,552** vs ₫40,550 quoted): **a timing offset, not bad data.** **Fourth guard added: when guard 2 fails, test whether a stated intraday move reconciles the figures before rejecting them.** *Recorded as UNDATED — "current"/"past 24 hours" carry no date, and every other name in the tally does.* **TCX P/B is 2.4569×; its kill criterion needs ₫33,009, an 18.6% fall — not met, not close.** *(Dated context: ATH ₫54,000 24-Feb-2026, ATL ₫35,100 04-Nov-2025.)* **METHOD, FINAL FORM — four one-division tests: =₫10,000 → par · reproduces the share count → confirms both · plausible price → catches unit errors · intraday-move reconciliation → catches timing offsets. THREE OF THE FOUR WERE FOUND BY BEING WRONG FIRST.** **Nothing modelled; `price` guarded §4 and untouched; no confidence moved; no new trigger fires.** *Next dated item: **US July payrolls, 19:30 ICT today** — the direct test of the 05-Aug pre-registration. **MBB's last cum session is Monday 10-Aug.***)*
