...
**Updated 06-Aug 19:40 ICT.** *(19:40 — **the owner supplied MBB's actual 1H26 analyst-meeting question list, and it confirms item 26 from outside while handing over the half of the income statement this file never recorded.** **ITEM 26 CONFIRMED VERBATIM BY THE STREET:** an analyst asked *"NPLs up, credit up strongly, provisioning up slowly — how much will MB provision in Q3 and Q4?"* **Third independent route to the same H2 shape** (branch arithmetic 02-Aug · management's own plan 16:53 · the sell-side now). **THE MISSING HALF, VERIFIED WITH NO EXTERNAL SOURCE:** `q1_nii` + `q2_nii` = ₫31,806.65bn over `h1_toi` 37,865 = **84.00% exact**, so the asserted **non-interest income −28.8%** closes the statement — non-II **₫8,509bn → ₫6,058bn**, prior share 26.1%, **NII +32.3%**, recomposing to ₫37,865bn and back-solving prior H1 PBT to **₫15,883.6bn vs ₫15,884bn on file.** **`q2_nii +36.55%` has been on file since 31-Jul and the collapse beside it never was** — MBB's +27.1% is spread income alone, with **NIM 3.9% vs 5.8% in 2022** and **cost of funds up four straight quarters**: volume, not price, which is why credit is planned at +30–35% against profit +15–20%. **⚠ THE DECIDING QUESTION, WHICH NOBODY AT THE MEETING ASKED:** FX −90% and securities ~0 are the smoothing lines — either **drained** (H2 guidance honest) or **held** (the owner's hypothesis, released into a guided-weak H2). **Field that separates them: unrealised gains in the securities book, notes to the 29-Aug statements.** **⚠ AN ANALYST ASKED A SHARPER MBV QUESTION THAN MINE** — *how much debt is MB selling to MBV* — and if NPLs move to an unconsolidated transferee, **MBB's 93.63% coverage is not on TCB's or VPB's basis and the 17:53 cross-section compares adjusted with unadjusted.** Flagged, not withdrawn. **⚠ MBB HAS NO REAL-ESTATE CRITERION** on a book that **doubled in 2025** with developer lending at **12% of loans** — TCB has three. **Seventh criteria defect, first of the absence type.** **CAR 10.5% in two years against credit +30–35%/yr makes the 11-Aug rights an instalment, not a one-off.** **Scored my own 15:53 list: 2 of 7, and my "NIM is public, don't ask" call was WRONG — the level is public, the inflection is not.** Nothing modelled; analyst questions rank below T5. New items 39, 40.)*
