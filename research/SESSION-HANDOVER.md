...
**Updated 07-Aug 10:53 ICT.** *(10:53 — **⚠⚠ THE "DECISIVE TEST" SERIES HAS ITS H1 PRINT AND THE FILE DID NOT HAVE IT.** KDH's short-term customer advances are **₫398.9bn at 30-Jun**, down from **₫648.3bn at 1-Jan (−38.5%)**; `398.9` appeared **zero times** in the repo. **It reconciles rather than contradicts:** the file's `customer_advances` 688.6 is the **Q1** figure, so the series is **648.3 (1-Jan) → 688.6 (31-Mar) → 398.9 (30-Jun)** — up in Q1, then **−42.1% in Q2.** **⚠ This is the series the file itself pre-registered:** *"customer advances matter more than profit — that is the forward-looking series and the armed kill criterion."* Against the criterion (*< ₫1,000bn at 3Q26 with Gladia launched*, **"armed — the decisive test"**, and **Gladia has launched**): **₫398.9bn is 39.9% of the bar and falling; clearing it needs a 2.51× rise in one quarter.** **NOT FIRED — it tests at 3Q26 and Q3 has not closed.** **⚠ AND A HEADLINE THAT LOOKS LIKE THE OTHER CRITERION BREACHING IS REFUSED:** total liabilities **₫19,497bn (+51%)** sails past *"debt > ₫18tn"*, **but *tổng nợ phải trả* is the wrong measure** — the file already holds **bank debt ₫16,500bn, ₫1,500bn BELOW the line. NOT CROSSED.** *Fifth broader-measure substitution this week.* **Headroom is thin but stated as extrapolation, not forecast: ₫1,500bn is 0.46 of a quarter at the H1 pace of ~₫3,250bn/qtr.** **THREE STRANDS NOW CONVERGE ON Q3/2026 on a 20.3% position** — advances vs ₫1,000bn · debt vs ₫18tn · the remaining **~₫1,675bn** of Bình Trưng Mới due by Q3 — **with inventory ₫29,488bn (+27% YTD) as the fourth.** **Nothing modelled; no criterion status changed; no confidence moved; no trigger fires.**)*
