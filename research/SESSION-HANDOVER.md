...
**Updated 06-Aug 19:53 ICT.** *(19:53 — **the last open cell in the rebar case closes and the answer is that the question did not matter.** `us_rebar_ad_final_range_pct` has held **[128.53, 136.57]** since 30-Jul with the note *"which end is Hoa Phat is not confirmed, and I am not asserting it."* **It is the LOW end: the Hoa Phat group carries 128.53%, the Vietnam-wide entity 136.57%, and HPG's cash deposit rate is 123.49%.** **The reason to believe it is that it reconciles to structure already on file** — the preliminary gap of 8.80pp (121.97 vs 130.77) becomes 8.04pp, and the export-subsidy offset is **5.04pp at both ends** of the cash-deposit range. **⚠ AND IT CHANGES NOTHING.** Three entries since 29-Jul tracked *which* end on the implicit premise that the distinction was economic. **At 128.53% versus 136.57% both rates are prohibitive; being 8.04pp better than an exporter who is also shut out is worth nothing.** Rebar is ~3% of HPG revenue and the brief already carries it as a Layer-4 flag. **Confidence unmoved — trade press reporting a Federal Register determination is not the determination**, and `federalregister.gov` and `trade.gov` both returned proxy 403 again. **Forecast #10 stays scored HIT from 29-Jul and is NOT re-scored** — a sub-question closed, not the forecast. **No escalation trigger fires.** Other lanes clean: TCB/VPB actions returned only the May–June cash dividends already on file, and **three stale steel prices were refused before any arithmetic** (62% Fe $104/t and coal $240/t, June vintage, wrong basis — the 09:53 grade trap and the 11:53 index-vs-transaction trap arriving together). **US initial claims were not yet indexed; the 20:53 sweep scores the 05-Aug pre-registration.**)*
