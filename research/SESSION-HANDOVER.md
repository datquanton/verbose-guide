...
**Updated 07-Aug 12:53 ICT.** *(12:53 — **applied last hour's method to the second-largest position; it worked, and the SAME disclosure produced the trap the method needs a guard against.** **KDH: ₫356bn ÷ 20m = ₫17,800 at ~20–21 Jul** (*"giá đóng cửa gần nhất"*), against the file's **₫18,000 — +1.1%**, and neither figure was on file. **With the 22-Jul ₫18,000 snippet, KDH now has two coherent dated points supporting the 24-Jul dating — a second name after VCI.** *The apparent anomaly resolves: KDH held ₫17,800→₫18,000 through a −6.55% index week because it had already fallen — the buy is reported as* **"bắt đáy"**, *bottom-fishing.* **⚠⚠ THE TRAP, FROM THE SAME SENTENCE: the disclosure ALSO quotes ₫200bn *"tính theo mệnh giá"* — at par — and ₫200bn ÷ 20m = ₫10,000 EXACTLY.** Two published values for one transaction, 78% apart, one of them meaningless as a price. **GUARD, arithmetic not judgement: if value ÷ count lands on ₫10,000, it is stated at par and carries NO price information** — Vietnamese filings do this routinely, so it is **the default hazard of the method.** **Re-run on all three earlier cases — ₫18,454 · ₫19,710 · ₫25,400 — none is par; yesterday's findings survive.** **⚠ WHERE ITEM 2 STANDS: dated observations on three of eight names, and on BOTH hard derivations the file's price is CORROBORATED (KDH +1.1%, VCI bracketed) — the opposite of the 01:53 conditional's uniform +4.63% premise. The staleness is real, name-specific, and small where measurable.** *Five names still have none; today's prices remain unavailable; item 2 stays open.* **Nothing modelled; `price` untouched; no confidence moved; no trigger fires.**)*
