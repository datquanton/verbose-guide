...
**Updated 06-Aug 22:53 ICT.** *(22:53 — **the FTSE gate stops being a month and becomes a day: the final constituent list is 21-AUG-2026, effective 21-SEP.** **Eleven trading sessions out — TRIGGER 5 DOES NOT FIRE** (the one that did is MBB's ex-rights, **3 sessions**, escalated at 18:53 and unchanged). **What 21-Aug settles is most of the book:** the 28-name provisional list holds **HPG 16.8 + KDH 20.3 + VCI 3.1 = 40.2%**, leaving **59.8% undetermined — TCB 35.0, VPB 10.0, MBB 6.5, TCX 5.5, VPX 2.8.** **And the 03-Aug withdrawal applies symmetrically:** that list was screened on **31-Dec-2024 data**, which is why TCX's absence was ruled uninformative — so absence cannot predict the final list for TCB, VPB or MBB either. **⚠ THE SEPTEMBER FLOW IS SMALL, AND IT PUTS ARITHMETIC UNDER ITEM 5 FOR THE FIRST TIME:** inclusion is phased **10/20/35/35**, total passive **~US$1.5bn**, of which **~US$150m in the September tranche** (check: 150/1,500 = 10%, matching the stated first phase). **Item 5's TCX tree prices "the FTSE event"; at the September step that is ~US$150m across ~30 stocks — a fraction of one day's HOSE turnover. Phasing was the qualitative objection of the three and is now the quantitative one.** *Limit stated: 10% is a weight phase, not a price prediction.* **VCI's criterion now has a window (21-Aug list, 21-Sep effective) and still lacks its measure** — it needs *foreign* brokerage share, the file holds *total*. **Untested, not passed.** *Nothing new on KDH: the 20m-share insider window (23-Jul–21-Aug) shows no execution filing, and Clarita/Emeria → Gladia plus the Q3-launch and the developer's "profit is a 2027 event" are all on file.* **Nothing modelled; no confidence moved.**)*
