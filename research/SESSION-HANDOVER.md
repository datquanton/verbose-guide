...
**Updated 06-Aug 23:53 ICT.** *(23:53 — **the July system credit print lands and July ran at HALF the H1 monthly pace.** **End-July system credit ~₫20.15 quadrillion, +8.38% YTD** against the file's end-June **+7.73%**. **Reconciled before use on the file's own numbers:** 20.15/1.0838 = ₫18.592qn at end-2025, which at +7.73% gives ₫20.029qn at end-June — *"past 20 million tỷ"*, the file's own wording. **H1 averaged 1.288pp/month; July added 0.650pp — 50%.** Seven months annualise to **14.37%**, on the ~15% system figure already in use. **⚠ THE CAVEAT NEARLY CANCELS THE FINDING AND IS STATED, NOT BURIED: Vietnamese credit is back-loaded and the H1 average is inflated by the June half-year push, so a slow July is the seasonal norm.** One month against a six-month average in a seasonal series is **weak evidence, recorded as weak.** **Where it bears: MBB's plan needs +14.8 to +19.3pp of H2 credit growth inside a system annualising to ~14.4% that just posted its slowest month** — **pressure on the plan, not refutation**, since a bank can outgrow a slowing system on quota reallocation. Multiples extend cleanly: MBB **1.71×** the system, VPB **2.98×**. **⚠ One series in the same source REFUSED on two grounds:** overnight 2.97% / 1-week 3.81% / **2-week 5.60%** is 179bp for one extra week — not credible — **and it is mislabelled**, headed *lãi suất huy động* when those are interbank tenors. **Second Vietnamese money-market series dropped in six hours; the failure mode is consistently a plausible number under the wrong label.** *Masterise lane returned a strict subset of what the file already holds — the source was less precise on every overlapping figure.* **Nothing modelled; no confidence moved; no escalation trigger fires.**)*
