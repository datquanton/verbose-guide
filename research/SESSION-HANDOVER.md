...
**Updated 06-Aug 20:53 ICT.** *(20:53 — **the 05-Aug pre-registration is scored and it is a MISS, and the larger error is that I chose a test which could not have settled the question.** **US initial claims, week ending 01-Aug: 199,000 against ~202,000 consensus; prior revised UP to 198,000; four-week average FELL 4,500 to 198,750.** On 05-Aug 21:53 I pre-registered a **weak** payroll print off ISM services employment 51.2 → 47.4 and named claims the first test. **Claims came in below consensus with the average falling — a tight labour market, the opposite direction. MISS.** **No partial credit taken** from the two-week uptick off the 57-year low (188k → 198k → 199k): a 1,000 weekly change is noise, and my own 22:53 standard about single-day moves applies to me. **⚠ THE BIGGER ERROR: claims measure SEPARATIONS, payrolls measure NET JOB CHANGE.** In a low-hire/low-fire market hiring stalls while layoffs stay at multi-decade lows, so **199k is not actually inconsistent with a weak payroll print** — a pre-existing structural fact that should have been stated on 05-Aug and was not. **Saying it now is a rescue; saying it then would have been test design.** It compounds the miss rather than excusing it. **The real resolution is US July payrolls, 07-Aug, left standing unmodified.** *Source note: `dol.gov/ui/data.pdf` and `oui.doleta.gov` both returned proxy 403, so this is wire coverage of the DOL release, not the release — the fourth blocked primary source this week after vsd.vn, federalregister.gov and trade.gov.* **Nothing modelled; no confidence moves; no escalation trigger fires.**)*
