...
**Updated 07-Aug 11:53 ICT.** *(11:53 — **⚠ I OVERSTATED IT AT 02:53 AND THE WALK-BACK IS THE FINDING.** That entry said item 2 is *"structurally unreachable from this environment"* and *"more hourly sweeps will not close it."* **Price PAGES are blocked; dated PRICES are not price pages and they leak out of transaction disclosures.** **VCI closed ₫18,450 on 27-Jul and hit ₫19,700 limit-up on 28-Jul** — both hard, both checkable (31.05m × 18,450 = ₫572.9bn against a stated ₫573bn). **⚠ And the file already held one unrecognised: its own 03-Aug "about ₫612bn" ÷ 31.05m = ₫19,710, the 28-Jul price — a dated quote recorded as a deal size.** **VPX ₫25,400 on 12-Jun** sits inside a market-cap sentence, equally uncounted. **METHOD: transaction VALUE ÷ share COUNT = dated PRICE — the reverse of the trick this file already used twice to recover share counts from ownership percentages.** **Three dated points bracket VCI's ₫20,500: +11.1% (27-Jul) / +4.1% (28-Jul) / −5.7% (04-Aug)** — exactly what a 24-Jul price should do if VCI fell into 27-Jul (*"sau nhịp giảm sàn"* — after a limit-DOWN session) and recovered. **So the 24-Jul presumption SURVIVES on this name and the staleness is TWO-SIDED, which weakens the beta-1 conditional published at 01:53.** **⚠ It does not price the book** — one name, three points, none from today. **Item 2 stays open and still needs a human refresh or FiinQuant; what changes is that sweeps CAN help, one transaction at a time, and the file should be read for prices it already contains before being declared blind.** *Also: no execution filing on VCI's 31.05m insider purchase; the IB pipeline search returned a strict subset of the 05-Aug entry; a one-day window-end discrepancy (02-Sep on file vs 03-Sep in coverage) flagged, not resolved.* **Nothing modelled; no confidence moved; no trigger fires.**)*
