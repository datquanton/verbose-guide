...
**Updated 07-Aug 07:53 ICT.** *(07:53 — **stopped finding defective criteria one per sweep and audited all SEVENTEEN. Fewer than one in three can actually be run.** **TESTABLE 5/17 (29%)** — TCB Q3 NIM <3.25% · TCB RE share >32% · HPG core NPAT/tonne · KDH customer advances at 3Q26 · VCI 9M PBT <55%. **NOT TESTABLE 8/17 (47%)** — TCB *"Masterise bond event"* (**three** undefined terms; ₫44,500bn of *successful* issuance satisfies the literal words) · VPB FE Credit 3.0% · MBB MBV drag · KDH *"matching pre-sale step-up"* · KDH *"operating PBT"* · VPX FVTPL gross-vs-net · VPX 5-licence cap · VCI foreign brokerage share. **CONDITIONAL 4/17** — VPB *"15% below market"* · HPG *"85% of nameplate"* · TCX *"P/B <2.0× on unchanged earnings"* · TCX foreign accumulation. **⚠ The defect rate is not bad luck; it is the majority state of the instrument.** **⚠ AND IT IS NOW A CHEAPER HUMAN TASK THAN ITEM 26: eight criteria need a DEFINITION, not an analysis; three conditionals need only a stated CONVENTION. An afternoon against a project.** **AND THE FIRST CRITERION RUN TO A VERDICT THIS WEEK — HPG PASSES:** core NPAT/tonne **₫1.682m (Q1)** and **₫1.803m (Q2)** against a ₫1.25m threshold — **35% and 44% above. NOT MET, not close.** *(The file's own convention reproduced exactly en route — core NPAT ÷ TOTAL steel volume — and it was nowhere written down.)* **After seven consecutive defect findings it matters that 29% of the set works.** **No search used; entirely internal. Nothing modelled; no criterion status changed; no confidence moved; no trigger fires.** New item 44.)*
