...
|---|---|---:|---:|---:|---:|---:|---:|---|
| 1 | **TCX** | +23.1% | 0.75 | **+17.3%** | -13.3% | 43% | 0.41 | Q2 official; 1H 47.1% of plan. MULTIPLE RESTATED 2026-08-02: the previous string read 'the risk is the MULTIPLE (2.49x P/B, priciest in book), not the earnings'. 2.49x IS NOT REPRODUCIBLE from this file's inputs plus TCBS's filed end-Q2 equity of 45,782bn. On the file's own price (41,100) and the filed share count (2,311,308,021), P/B is 2.075x; 2.49x requires a price near 49,322 or a book near 38,151bn, neither on file. The earnings half of the sentence stands. Separately the file's two market caps disagree by 15.5% (price x shares 94,995bn vs pe_ttm x npat_ttm 82,215bn), so pe_ttm 20.3 or npat_ttm 4,050 is wrong. Confidence 0.80 -> 0.75: not because the name got worse - the margin-capacity constraint recorded on 31-Jul was withdrawn today in TCX's favour - but because the input the evidence string names as THE risk cannot be reconstructed. Judgment inputs (exit_pe, probs, fy26e_npat) untouched. |
...
- **BUY TCX** — 5.5% → 11.0% (+5.5pp; north star 20.0%). E[r] +17.3%, bear branch -13.3%. Q2 official; 1H 47.1% of plan. MULTIPLE RESTATED 2026-08-02: the previous string read 'the risk is the MULTIPLE (2.49x P/B, priciest in book), not the earnings'. 2.49x IS NOT REPRODUCIBLE from this file's inputs plus TCBS's filed end-Q2 equity of 45,782bn. On the file's own price (41,100) and the filed share count (2,311,308,021), P/B is 2.075x; 2.49x requires a price near 49,322 or a book near 38,151bn, neither on file. The earnings half of the sentence stands. Separately the file's two market caps disagree by 15.5% (price x shares 94,995bn vs pe_ttm x npat_ttm 82,215bn), so pe_ttm 20.3 or npat_ttm 4,050 is wrong. Confidence 0.80 -> 0.75: not because the name got worse - the margin-capacity constraint recorded on 31-Jul was withdrawn today in TCX's favour - but because the input the evidence string names as THE risk cannot be reconstructed. Judgment inputs (exit_pe, probs, fy26e_npat) untouched.
