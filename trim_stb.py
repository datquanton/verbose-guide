...
EN = {
 ...
 4: ("The NPL ratio reached 7.54% at end-2Q26, up 1.13%p year-to-date and the highest in the "
     ...
     "of VND11.8tn, or 37% of the Group 5 balance, leaving coverage at 51.0%. Holding coverage "
 ...
 6: ("STB recorded VND7,331bn of PBT in 1H25 but only VND297bn in 2H25, as 4Q25 registered a "
     "pre-tax loss of VND3,360bn. We set FY26F PBT at VND8,150bn (+6.9% YoY), marginally above "
     "the board-approved plan of VND8,100bn. The cost line does the lifting — 1H26 CIR came in "
     "at 35.6% against the 42.9% previously carried, and we now assume 40.0% (-0.7%p YoY), 38.0% "
     "in FY27F and 36.0% in FY28F — with the balance taken back in provisioning. That implies "
     "2H26 PBT of VND4,014bn, around 14x the 2H25 base. Other "
     "FY26F assumptions: NII of VND26,712bn (+0.1% YoY), NIM of 2.92% (-40bps YoY) and "
     "provisioning of VND11.4tn (+0.6% YoY); we flag 1H26 loan growth of 1.5% against the 11.7% "
...
VN = {
 ...
 3: ("Chất lượng tài sản suy giảm vượt mức ban lãnh đạo dự kiến: tỷ lệ nợ xấu đạt 7.54% cuối "
     ...
     "đồng, tương đương 37% dư nợ nhóm 5, đưa bao phủ về 51.0%. Việc giữ bao phủ quanh 50% giới "
 ...
 5: ("STB ghi nhận 7,331 tỷ đồng LNTT trong 1H25 nhưng chỉ 297 tỷ đồng trong 2H25, do Q4/2025 lỗ "
     "trước thuế 3,360 tỷ đồng. Chúng tôi đặt dự phóng LNTT FY26F ở 8,150 tỷ đồng (+6.9% CK), "
     "nhỉnh hơn kế hoạch 8,100 tỷ đồng đã được ĐHĐCĐ thông qua. Chi phí hoạt động là động lực "
     "chính — CIR 1H26 chỉ 35.6% so với 42.9% dự phóng trước đây, và chúng tôi điều chỉnh về "
     "40.0% (-0.7%p CK), 38.0% FY27F và 36.0% FY28F — phần chênh còn lại đưa vào chi phí dự "
     "phòng. Mức này hàm ý LNTT 2H26 khoảng 4,014 tỷ đồng, tương đương khoảng 14 lần nền 2H25."),
 6: ("Các giả định FY26F khác: NII 26,712 tỷ đồng (+0.1% CK), NIM 2.92% (-40bps CK) và chi phí dự "
     "phòng 11.4 nghìn tỷ đồng (+0.6% CK); lưu ý tăng trưởng tín dụng 1H26 chỉ 1.5% so với 11.7% "
