...
EN = {
 ...
 6: ("STB recorded VND7,331bn of PBT in 1H25 but only VND297bn in 2H25, as 4Q25 registered a "
     "pre-tax loss of VND3,360bn. We raise FY26F PBT to VND8,507bn (+11.5% YoY) from VND7,934bn, "
     ...
     "2H26 opex 9.6% above 1H26, and implies 2H26 PBT of VND4,371bn — around 15x the 2H25 "
     "base. Other "
...
VN = {
 ...
 5: ("STB ghi nhận 7,331 tỷ đồng LNTT trong 1H25 nhưng chỉ 297 tỷ đồng trong 2H25, do Q4/2025 lỗ "
     "trước thuế 3,360 tỷ đồng. Chúng tôi nâng dự phóng LNTT FY26F lên 8,507 tỷ đồng (+11.5% CK) "
     ...
     "này vẫn cho phép chi phí hoạt động 2H26 cao hơn 1H26 9.6%, hàm ý LNTT 2H26 khoảng 4,371 "
