...
EN = {
 ...
 4: ("The NPL ratio reached 7.54% at end-2Q26, up 1.13%p year-to-date and the highest in the "
     ...
     "of VND11.8tn, or 37% of the Group 5 balance, leaving coverage back at 50.0%. Holding "
     "coverage at 50% is what caps the improvement at 5.5%, and it needs 2H26 NPL formation at "
     "roughly a quarter of the 1H26 pace."),
 6: ("STB recorded VND7,331bn of PBT in 1H25 but only VND297bn in 2H25, as 4Q25 registered a "
     "pre-tax loss of VND3,360bn. We raise FY26F PBT to VND8,683bn (+13.8% YoY) from VND7,934bn, "
     "entirely on the cost line: 1H26 CIR came in at 35.6% against the 42.9% previously carried, "
     "and we now assume 40.0% (-0.7%p YoY), 38.0% in FY27F and 36.0% in FY28F. That still allows "
     "2H26 opex 11.5% above 1H26, and implies 2H26 PBT of VND4,547bn — around 15x the 2H25 "
     "base. Other "
     "FY26F assumptions: NII of VND27,010bn (+1.2% YoY), NIM of 2.94% (-38bps YoY) and "
     "provisioning of VND11.1tn (-2.6% YoY); we flag 1H26 loan growth of 1.5% against the 11.7% "
...
VN = {
 ...
 3: ("Chất lượng tài sản suy giảm vượt mức ban lãnh đạo dự kiến: tỷ lệ nợ xấu đạt 7.54% cuối "
     ...
     "đồng, tương đương 37% dư nợ nhóm 5, đưa bao phủ về 50.0%. Việc giữ bao phủ ở 50% giới hạn "
     "mức cải thiện ở 5.5%, đồng thời cần nợ xấu phát sinh mới 2H26 chỉ bằng khoảng một phần tư "
     "nhịp 1H26."),
 5: ("STB ghi nhận 7,331 tỷ đồng LNTT trong 1H25 nhưng chỉ 297 tỷ đồng trong 2H25, do Q4/2025 lỗ "
     "trước thuế 3,360 tỷ đồng. Chúng tôi nâng dự phóng LNTT FY26F lên 8,683 tỷ đồng (+13.8% CK) "
     "từ 7,934 tỷ đồng, hoàn toàn nhờ chi phí hoạt động: CIR 1H26 chỉ 35.6% so với 42.9% dự phóng "
     "trước đây, và chúng tôi điều chỉnh về 40.0% (-0.7%p CK), 38.0% FY27F và 36.0% FY28F. Mức "
     "này vẫn cho phép chi phí hoạt động 2H26 cao hơn 1H26 11.5%, hàm ý LNTT 2H26 khoảng 4,547 "
     "tỷ đồng — khoảng 15 lần nền 2H25."),
 6: ("Các giả định FY26F khác: NII 27,010 tỷ đồng (+1.2% CK), NIM 2.94% (-38bps CK) và chi phí dự "
     "phòng 11.1 nghìn tỷ đồng (-2.6% CK); lưu ý tăng trưởng tín dụng 1H26 chỉ 1.5% so với 11.7% "
