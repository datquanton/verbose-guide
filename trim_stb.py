...
EN = {
 ...
 4: ("The NPL ratio reached 7.54% at end-2Q26, up 1.13%p year-to-date and the highest in the "
     ...
     "of VND11.8tn, or 37% of the Group 5 balance, leaving coverage at 50.0%. Holding coverage "
     "at 50% is what caps the improvement at 5.5%, and it needs 2H26 NPL formation at roughly a "
     "quarter of the 1H26 pace."),
 6: ("STB recorded VND7,331bn of PBT in 1H25 but only VND297bn in 2H25, as 4Q25 registered a "
     "pre-tax loss of VND3,360bn. We set FY26F PBT at VND8,507bn (+11.5% YoY), 5% above the "
     "board-approved plan of VND8,100bn. The cost line does the lifting — 1H26 CIR came in at "
     "35.6% against the 42.9% previously carried, and we now assume 40.0% (-0.7%p YoY), 38.0% in "
     "FY27F and 36.0% in FY28F. That still allows 2H26 opex 9.6% above 1H26, and implies 2H26 "
     "PBT of VND4,371bn, around 15x the 2H25 base. Other "
...
VN = {
 ...
 5: ("STB ghi nhận 7,331 tỷ đồng LNTT trong 1H25 nhưng chỉ 297 tỷ đồng trong 2H25, do Q4/2025 lỗ "
     "trước thuế 3,360 tỷ đồng. Chúng tôi đặt dự phóng LNTT FY26F ở 8,507 tỷ đồng (+11.5% CK), "
     "cao hơn 5% so với kế hoạch 8,100 tỷ đồng đã được ĐHĐCĐ thông qua. Chi phí hoạt động là "
     "động lực chính — CIR 1H26 chỉ 35.6% so với 42.9% dự phóng trước đây, và chúng tôi điều "
     "chỉnh về 40.0% (-0.7%p CK), 38.0% FY27F và 36.0% FY28F. Mức này vẫn cho phép chi phí hoạt "
     "động 2H26 cao hơn 1H26 9.6%, hàm ý LNTT 2H26 khoảng 4,371 tỷ đồng, tương đương khoảng 15 "
     "lần nền 2H25."),
